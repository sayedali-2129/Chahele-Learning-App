...
class ExamResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int optionLength =
        examProvider.examDataList!.examData[index].options.length;
    int questionCount = examProvider.examDataList!.examData.length;
                        ...
                        itemBuilder: (context, optionIndex) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: examProvider.examDataList!
                                        .examData[questionIndex].answer ==
                                    optionIndex
                                ? Colors.green.withOpacity(0.7)
                                : selectedOption[questionIndex] == optionIndex
                                    ? optionIndex ==
                                            examProvider.examDataList!
                                                .examData[questionIndex].answer
                                        ? Colors.green.withOpacity(0.7)
